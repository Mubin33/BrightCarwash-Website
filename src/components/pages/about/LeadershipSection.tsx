...
export function LeadershipSection() {
  ...
  return (
    <section
      className={`flex py-20 px-4 md:px-6 lg:px-10 flex-col justify-center items-center gap-12 self-stretch ${isDark ? "bg-[#1A1A1A]" : "bg-[#ffffff]"}`}
    >
      <SectionHeader
        badgeIcon="car"
        ...
        heading={
          <>
            <div className="whitespace-nowrap">
              MEET THE PEOPLE <span className="">BEHIND</span>
            </div>
            BRIGHTSIDE <span className="text-[#0098E8]">CARWASH</span>
          </>
        }
        subheading={[
      ...
      <div>
        <div
          className={`flex flex-col lg:flex-row items-start gap-6 w-full max-w-330`}
        >
          {/* Card 1 - Jonathan Roldan */}
          <div
            className={`flex-1 rounded-lg outline-none inline-flex flex-col justify-start items-start gap-6 ${isDark ? "bg-[#252019] text-white" : "bg-[#F8FAFB] text-[#1D1F2C] border border-[#DFE1E7]"}`}
          >
            <div
              className={`${isDark ? "border border-[#FEC300]" : ""} self-stretch p-6 bg-sky-950 rounded-lg flex flex-col justify-start items-start gap-4 overflow-hidden `}
            >
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              <div className="self-stretch px-6 py-4 inline-flex justify-center items-center gap-2.5">
                <div className="flex-1 text-justify justify-start text-base font-normal font-['Inter'] leading-6">
                  After serving in the U.S. Army, Jonathan founded Brightside on
                  the values of integrity, hard work, and service. Those same
                  principles guide everything we do from how we care for every
                  vehicle to how we support and develop our team.
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              <div className="self-stretch px-6 py-4 inline-flex justify-center items-center gap-2.5">
                <div className="flex-1 text-justify justify-start text-base font-normal leading-6">
                  Under the leadership of CEO Elizabeth Quinn, Brightside
                  champions a community-first approach, emphasizing
                  transparency, dedication, and exceptional service to ensure
                  outstanding vehicle maintenance and unwavering support for our
