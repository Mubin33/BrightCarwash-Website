...
export function ContactInfoForm({ values, onChange }: Props) {
    ...
    const inputClass = `flex py-4 px-4 justify-between items-center self-stretch rounded-lg border text-[#1D1F2C] font-inter text-sm outline-none focus:border-[#0098E8] placeholder-[#A5A5AB] ${isDark
                    ...
                    <div className="flex flex-col sm:flex-row items-start gap-4 self-stretch">
                        <div className="w-full flex flex-col items-start gap-2 flex-1">
                            ...
                            <input
                                type="text"
                                placeholder="John"
                                className={` flex py-4 px-4 justify-between items-center self-stretch rounded-lg border font-inter text-sm outline-none focus:border-[#0098E8] placeholder-[#A5A5AB] ${isDark
                                    ? 'border-white/20 bg-white/[0.08] text-white placeholder:text-white/30'
                                    : 'border-[#DFE1E7] bg-[#F8FAFB] text-[#1D1F2C]'
                                    }`}
