...
export function PaymentDetailsForm({ agreed, onAgreeChange }: Props) {
            ...
            <div className="flex flex-col items-start gap-6 self-stretch">
                ...
                <label className="flex items-center gap-2 self-stretch cursor-pointer">
                    ...
                    <span className={`font-inter text-sm ${isDark ? 'text-white/70' : 'text-[#777980]'}`}>
                        I have read and agreed to the <span className='text-black'>Privacy & Policy</span> of Brightside Car Wash.
                    </span>
                </label>
            </div>
        </div>
