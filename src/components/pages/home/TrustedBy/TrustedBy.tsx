...
export function TrustedBy() {
    ...
    return (
        <section className={`self-stretch px-4 md:px-8 lg:px-16 xl:px-72 py-8 flex flex-col justify-center items-center gap-5 overflow-hidden ${isDark ? 'bg-[#1A1A1A] outline-white/20' : 'bg-white outline-stone-200/20'} outline outline-1 outline-offset-[-1px]`}>
