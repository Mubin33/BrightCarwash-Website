      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full max-w-[1320px]">
          {[...Array(6)].map((_, i) => (
            <div
              key={i}
              className="h-[300px] sm:h-[500px] bg-gray-100 animate-pulse rounded-lg"
            />
          ))}
        </div>
      </section>
  ...
  return (
    ...
    >
      <SectionHeader
        ...
        heading={
          <>
            Discover what our happy <br /> clients are{" "}
            <span className="text-[#0098E8]">saying!</span>
          </>
        }
      ...
      <div className="columns-1 md:columns-2 lg:columns-3 gap-1 w-full max-w-[1280px] xl:max-w-[1320px] [&_>_*]:mb-0">
