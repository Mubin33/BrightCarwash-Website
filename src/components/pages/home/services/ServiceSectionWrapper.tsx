...
export function ServicesSectionWrapper() {
    ...
    if (loading) {
        return (
            <section
                className={`flex py-20 px-4 sm:px-6 md:px-10 lg:px-6 xl:px-40 2xl:px-[300px] flex-col justify-center items-center gap-12 self-stretch ${isDark ? 'bg-[#1A1A1A]' : 'bg-white'
                    }`}
            >
    ...
    return (
        <section
            id="services"
            className={`flex py-20 px-4 sm:px-6 md:px-10 lg:px-6 xl:px-40 2xl:px-[300px] flex-col justify-center items-center gap-12 self-stretch ${isDark ? 'bg-[#1A1A1A]' : 'bg-[#ECEFF3]'
                }`}
        >
            <ServicesHeader />
