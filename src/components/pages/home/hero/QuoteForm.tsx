...
export function QuoteForm() {
    ...
    return (
        <div className="flex w-[600px] p-5 flex-col items-center gap-6 rounded-xl bg-white">
            <div className="flex flex-col items-start gap-6 self-stretch">
                {/* Header */}
                <div className="flex flex-col justify-center items-center gap-3 self-stretch rounded-lg bg-[#092544] p-6">
                    <span className="text-white font-bebas-neue text-[32px] leading-[100%] self-stretch text-start">
                        Get Your Free Quote
                    </span>
                    <span className="text-white/80 font-inter text-base leading-[160%] self-stretch text-start">
                ...
                <div className="flex flex-col items-start gap-4 self-stretch">
                    <div>
                        <h3 className="text-[#4A4C56] font-bebas-neue text-xl leading-[100%] self-stretch">
                            What vehicle do you drive?
                        </h3>
                        <p className="text-[#777980] font-inter text-base leading-[100%] mt-2">
