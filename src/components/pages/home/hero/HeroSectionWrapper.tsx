...
export function HeroSectionWrapper() {
    return (
        <section
            className="font-bebas flex py-10 px-4 sm:px-6 md:px-10 lg:px-[300px] flex-col justify-center items-center gap-[10px] self-stretch min-h-screen"
            style={{
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-14 self-stretch">
                ...
                <div className="flex flex-col items-start gap-8 lg:gap-12 flex-1 w-full">
                    <div className="flex flex-col items-start gap-3">
                        ...
                        {/* Headline */}
                        <h1 className="w-full lg:w-[536px] font-bebas-neue text-4xl sm:text-5xl md:pt-16 md:text-6xl lg:text-[72px] font-normal leading-[120%] tracking-[2px]">
