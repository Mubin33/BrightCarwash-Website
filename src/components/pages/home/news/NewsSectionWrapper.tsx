...
export function NewsSectionWrapper() {
  ...
  return (
    <section
      className={`flex py-20 px-4 md:px-6 lg:px-10 flex-col justify-center items-center gap-12 self-stretch border ${isDark ? "border-white/20 bg-[#1A1A1A]" : "border-[#DFE1E7] bg-[#ECEFF3]"}`}
    >
      <SectionHeader
        badgeIcon="car"
        ...
        heading={
          <>
            ...
            <span className="text-[#0098e8]">BrightSide's</span> latest updates!
          </>
        }
      ...
      <div className="flex flex-col lg:flex-row items-stretch gap-6 w-full max-w-[1280px] xl:max-w-[1320px]! ">
        ...
        >
          <div className="h-56 sm:h-80 lg:h-81 self-stretch relative">
            <Image
      ...
      <Link href="/news">
        <Button className="flex py-3.5 px-5 justify-center items-center gap-2 rounded-lg bg-[#FEC300] text-black font-inter text-base sm:text-lg hover:bg-[#FEC300]/80 duration-300">
          Read All
          <MoveUpRight size={16} />
        </Button>
      </Link>
