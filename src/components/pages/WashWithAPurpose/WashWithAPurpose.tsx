...
export default function WashWithAPurpose() {
  return (
    <div>
      <div className="py-10 lg:py-20 max-w-330 mx-auto px-4 xl:px-0">
        ...
        <div className="mt-4 lg:mt-6">
          <div>
            <h1 className="text-[#FEC300] text-2xl font-bebas uppercase text-center">
              Clean Car. Stronger Community.Real Impact.
            </h1>
            <p className="text-center text-xs sm:text-sm lg:text-base text-[#4A4C56] dark:text-white/80 my-3">
              Every membership helps strengthen the organizations that make our
              community better.
            </p>
          </div>
          <p className="border border-[#8AD0F4] rounded-lg text-[#0098E8] bg-[#E6F5FD] text-xs lg:text-sm text-center p-3 lg:p-4">
            If you provide your phone number at checkout and opt in to texts,
            you consent to receive marketing messages (promos & reminders) from
            Brightside Car Wash. Consent is not a condition of purchase. Msg &
            data rates may apply. Msg frequency varies. Unsubscribe anytime by
            replying STOP. Privacy Policy & Terms here.
          </p>
        </div>
      </div>
    </div>
